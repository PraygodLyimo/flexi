...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[120vh] py-0 md:py-10 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-6xl md:text-8xl font-bold dark:text-white font-great-vibes text-[#947846] mb-8">
        Our Safari Tours
      </h1>
      <p className="max-w-2xl text-xl md:text-2xl mt-8 dark:text-neutral-200 text-white font-medium leading-relaxed" style={{ fontFamily: 'var(--font-montserrat)' }}>
        <EncryptedText 
          text="Experience the raw beauty of Tanzania's wilderness with our meticulously crafted luxury safari tours."
          revealDelayMs={30}
        />
      </p>
    </div>
